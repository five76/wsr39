...
Специальные команды (ad hoc commands)
"""""""""""""""""""""""""""""""""""""""""
Специальная команда Ansible использует инструмент командной строки /usr/bin/ansible для автоматизации одной задачи на одном или нескольких управляемых узлах. Специальные команды выполняются быстро и легко, но их нельзя использовать повторно.

Специальные команды демонстрируют простоту и мощь Ansible. Концепции применяются непосредственно на язык playbook. 
